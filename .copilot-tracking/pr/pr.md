...
- `scripts/validate_release_sbom_contract.py` — stdlib-only checks for the exact release product, version, supplier/originator, runtime dependencies, and document/root topology; generic SPDX rules remain owned by official tooling
